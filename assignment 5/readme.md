...
🔹 Step 1: Create Project Structure 1. Create a folder:
...
🔹 Step 5: Setup MySQL Database 1. Open terminal:
...
🔹 Step 6: Download and Add MySQL JAR 1. Download MySQL Connector (Platform Independent ZIP) 2. Extract it 3. Copy .jar file 4. Paste inside:

assignment5/WEB-INF/lib/

⸻

🔹 Step 7: Compile Servlet 1. Open terminal 2. Navigate to project folder:
...
🔹 Step 9: Setup and Start Tomcat 1. Go to Tomcat folder:
